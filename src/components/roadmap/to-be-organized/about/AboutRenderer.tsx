...
import storeAboutTemporary from '@components/roadmap/to-be-organized/about/stores/store-about-temp';
...
const AboutRenderer = () => {
  const { description, name, author, theme } = useStore(storeAboutTemporary);
