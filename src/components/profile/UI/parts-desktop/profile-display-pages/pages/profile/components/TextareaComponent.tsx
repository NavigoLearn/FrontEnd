...
const TextareaComponent = ({
  ...
  return (
    <div className='relative'>
      <textarea
        className={`font-roboto-text h-36 resize-none font-medium text-md text-darkBlue w-80 monitor:w-96   rounded-md border-[1.5px] border-placeholderBlack px-3 py-2 ${
          !editable
